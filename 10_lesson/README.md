...
- Используются docstrings (стиль reStructuredText) для документирования методов и функций.
...
2. В отчете Allure вы увидите:
   - **Название теста**: Например, `Тест оформления заказа`.
   - **Описание теста**: Например, `Авторизация, добавление товаров, переход к оформлению и проверка итоговой суммы`.
   - **Шаги теста**:
